    ...
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarStyle: {
          ...
          borderTopWidth  : 0,
          elevation       : 0,         // Android : supprimer l'ombre native
          shadowOpacity   : 0,         // iOS
          height          : 62,
          paddingTop      : 6,
        },

        // ── Indicateur onglet actif (point sage sous l'icône) ──
...
export default function RootNavigator() {
  ...
  // Splash pendant l'hydratation AsyncStorage → évite le flash WelcomeScreen
  if (isLoading) {
    return (
