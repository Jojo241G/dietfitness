...
const EXERCISES_DATABASE = [
  ...
  }, // 💡 Correction : La fermeture de cet objet était manquante !
  {
    id: '3',
  ...
  },
  {
    ...
    objective: 'Prise de masse',
    animationUrl: 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExeHN3ZDM5cHZjcGc3ODhlemIyN2M3aXUxNmRkMzhhNHlpdXBzbnprNCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/qZNYZCjuXqw1IwFzrZ/giphy.gif'
  },
  // --- MAINTIEN DE FORME ---
  {
    id: '7',
...
export default function FitnessScreen({ navigation }) {
  ...
  // Filtrage dynamique des exercices en fonction de l'objectif du profil utilisateur
  ...
  const renderExerciseItem = ({ item }) => (
    ...
    >
      {/* Conteneur de l'animation graphique réelle */}
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {navigation && (
          <TouchableOpacity style={styles.parcoursBtn} onPress={() => navigation.navigate('Parcours')} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#f7f3ec', // Fond crème douce
  },
  header: {
  ...
  headerTitle: {
    fontSize: 24,
    fontWeight: 'bold',
    color: '#1c3a2e', // Vert forêt
  },
  headerSubtitle: {
    fontSize: 14,
    color: '#3d6b52', // Vert sauge
    marginTop: 4,
  },
  parcoursBtn: {
    flexDirection: 'row',
  ...
  durationBadge: {
    backgroundColor: '#3d6b52', // Vert sauge
  },
  difficultyBadge: {
    backgroundColor: '#1c3a2e', // Vert forêt dense
  },
  kcalBadge: {
    backgroundColor: '#d4a017', // Or/ambre
  },
  badgeText: {
    color: '#ffffff',
    fontSize: 12,
